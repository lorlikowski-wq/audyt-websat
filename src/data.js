// Audit data — extracted from Nobelica / Web-Sat audit example.
...
export const fmt_pln = (n) => n.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' zł';
export const fmt_n = (n, d = 2) => n.toLocaleString('pl-PL', { minimumFractionDigits: d, maximumFractionDigits: d });
...
export const SPEED_TOTAL_FINE = SPEEDING.reduce((s, v) => s + v.fine, 0);
export const SPEED_TOTAL_PTS = SPEEDING.reduce((s, v) => s + v.pts, 0);

export const SPEED_DIST = [
...
export const TREND = {
  ...
  norma:  [320, 320, 320, 320, 320, 320, 320],
  rzecz:  [340, 348, 360, 370, 378, 388, 392],
};
...
export const OVERALL_SCORE = Math.round(AREAS.reduce((s, a) => s + a.score, 0) / AREAS.length);
