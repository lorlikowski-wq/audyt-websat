...
import { MOCK_FILES } from '../data.js';
import { Icon } from '../ui.jsx';

export default function ScreenUpload({ onNext }) {
    ...
    <main className="work" data-screen-label="01 Wczytaj dane">
      <div className="section-head">
        ...
        <button className="btn btn--primary" onClick={onNext}>
          Dalej — wyliczenia <Icon name="arrow-right" />
        </button>
      </div>
      ...
      <div className="upload-grid">
        <div>
          ...
          >
            <div className="glyph"><Icon name="upload" size={22} /></div>
          ...
          <div className="file-list">
            {files.map((f, i) => (
              <div className="file-row" key={i}>
                ...
                <div className="status"><Icon name="check" size={12} /> {f.status}</div>
                <button
        ...
        <aside className="upload-side">
          ...
          <div className="req">
            ...
            <span className="check"><Icon name="check" size={12} /> Cena ON: 6,40 zł/L</span>
          </div>
          <div className="req">
            <h4>Prędkość i mandaty</h4>
            <p>Przekroczenia &gt; 20 km/h, taryfikator PL+DE, punkty karne, ryzyko prawa jazdy.</p>
            <span className="check"><Icon name="check" size={12} /> Norma: 28 L/100km</span>
          </div>
          <div className="req">
            <h4>Compliance i środowisko</h4>
            <p>Kontrole e-TOLL, emisja CO₂ (CSRD), nacisk na oś (CAN FD), tachograf G2V2, LTC.</p>
            <span className="check"><Icon name="check" size={12} /> Wzorzec: Web-Sat 2026</span>
          </div>
