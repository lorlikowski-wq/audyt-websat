...
export const Sparkline = ({ values, color = 'var(--accent)', height = 28, fill = true }) => {
...
export const Ring = ({ value, max = 100, size = 220, stroke = 14, color = 'var(--accent)', track = 'var(--hair-2)' }) => {
