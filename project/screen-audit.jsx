// Step 3 — Audit document, restructured for fleet/fuel audit (Nobelica/Web-Sat).

const SpeedDistChart = () => {
  const { SPEED_DIST } = window.AUDIT_DATA;
  return (
...
const ScreenAudit = ({ onBack }) => {
  const { KPIS, FINDINGS, SPEEDING, SPEED_TOTAL_FINE, SPEED_TOTAL_PTS,
          RECOMMENDATIONS, AREAS, FLEET, OVERALL_SCORE, VERDICT,
          INPUTS, CALC, fmt_pln, fmt_n } = window.AUDIT_DATA;
    ...
    <main className="work" data-screen-label="03 Audyt">
      <div className="audit-actionbar">
        ...
        <div style={{ display: "flex", gap: 6 }}>
          <button className="btn" onClick={onBack}><window.UI.Icon name="arrow-left" /> Wróć do edycji</button>
          <button className="btn"><window.UI.Icon name="share" /> Udostępnij</button>
          <button className="btn" onClick={() => window.print()}><window.UI.Icon name="print" /> Drukuj</button>
          <button className="btn btn--primary"><window.UI.Icon name="download" /> Pobierz PDF</button>
        </div>
      </div>
      ...
      <article className="audit-doc" id="audit-doc">
        ...
        <section className="audit-page">
          ...
          <div className="rec-list" style={{ marginTop: 28 }}>
            <div className="rec"><div className="idx">01</div><div>
            ...
            </div><div className="meta"><span className="chip crit"><span className="dot" />Krytyczny</span></div></div>

            <div className="rec"><div className="idx">02</div><div>
            ...
            <div className="rec"><div className="idx">03</div><div>
            ...
            <div className="rec"><div className="idx">04</div><div>
            ...
            <div className="rec"><div className="idx">05</div><div>
            ...
            </div><div className="meta"><span className="chip warn"><span className="dot" />Estymacja</span></div></div>
          </div>
        ...
        <section className="audit-page">
          ...
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, color: "var(--muted)", marginBottom: 16, fontFamily: "var(--mono)" }}>
            {window.AUDIT_DATA.SPEED_DIST.map((d,i) => <span key={i}>{d.range}</span>)}
          </div>
